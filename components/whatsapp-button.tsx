...
export function WhatsAppButton() {
  ...
  const defaultMessage = "Bonjour Veky-Shop ! Je vous contacte à propos de vos services d'achats internationaux."
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 hover:scale-110 active:scale-95 transition-all duration-300"
